...
n.includes(i)||n.push(i)}}return n.sort(),n},g=function(){for(var e=[],n=0;n<l.length;n++){var t=l[n]
...
o.style.display=n.includes(i)?"block":"none"}E()},w=window.dispatchEvent,C=function(n){for(var t=e(m+" div"),o=0;o<t.length;o++){t[o].style.display=""}if(r(Event))w(new Event("resize"))
else{var i=document.createEvent("UIEvents")
i.initUIEvent("resize",!0,!1,window,0),w(i)}},x=function(e,n){var t=r(e)?"nn"+Math.random():e,o=r(n)?n:e
return y[t]=o,M},L=function(e){var n=null
if("string"==typeof e)n=e
else{var n=null
for(var t in y)callback===e&&(n=t)}return n||delete y[n],M}
...
i.innerText="body > ."+f+" { visibility: hidden; } \nbody > ."+f+" > div { display: none; }\n",n.appendChild(i),document.body.appendChild(n)}(),n("DOMContentLoaded",E),n("load",E),n("resize",E)
var M={currentModes:g,changeModes:b,clearModes:C,selector:m,watch:x,unwatch:L}
return M}}})
